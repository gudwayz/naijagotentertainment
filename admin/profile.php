...
else if (!password_verify($validated_data['currentpassword'] ,  $userpassword))   
{
	...
	$userfirstname = $validated_data['firstname'];
      ...
      $userphone = $validated_data['phone'];
      $updatequery1 = "UPDATE user SET firstname = '$userfirstname' , lastname='$userlastname' , phone='$userphone' ,email='$useremail' WHERE u_id = '$userid' " ;
...
$updatequery = "UPDATE users SET password = '$userpassword', firstname='$userfirstname' , lastname= '$userlastname' , phone= '$userphone' , email= '$useremail' WHERE id='$userid'";
...
<div class="form-group">
	...
	<div class="form-group">
		<label for="user_tag">Phone</label>
		<input type="email" name="text" class="form-control" value="<?php echo $userphone; ?>" required>
	</div>
