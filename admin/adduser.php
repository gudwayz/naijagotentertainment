...
$gump->validation_rules(array(
	...
	'phone'       => 'required|numeric|max_len,14|min_len,11',
...
else if ($_POST['password'] !== $_POST['cpassword']) 
{
	echo  "<center><font color='red'>Passwords do not match </font></center>";
      ...
      $query = "INSERT INTO user(username,firstname,lastname,email,phone,password,role) VALUES ('$username' , '$firstname' , '$lastname' , '$email','$phone', '$password' , '$role')";
